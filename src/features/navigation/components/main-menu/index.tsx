...
function MainMenu() {
      ...
      () =>
        detectActive(
          [
            ...
            {
              key: 2,
              title: t('navigation.main-menu.example-modals'),
              link: '/example-modals',
              active: false,
            },
            {
              key: 3,
              title: t('navigation.main-menu.example-i18n'),
              link: '/example-i18n',
              active: false,
            },
            ...
            {
              key: 7,
              title: t('navigation.main-menu.canvas'),
              link: '/example-canvas',
              active: false,
            },
          ],
  ...
  const linkRender = useCallback((item: MenuItem) => <Link to={item.link}>{item.title}</Link>, []);
