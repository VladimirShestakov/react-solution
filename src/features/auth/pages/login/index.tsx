  ...
  return (
    <PageLayout>
      ...
      <p>
        ...
        к форме авторизации. В шапке сайта выводится информация про сессию - имя авторизованного
        пользователя
        и кнопка для выхода (сброса сессии). Токен сессии сохраняется в LocalStorage или в куку для
        автоматического восстановления сессии. Проверка и восстановление сессии выполнится при
        попытке
